namespace Loupedeck.ControlMapperPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.ControlMapperPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.ControlMapperPlugin.Resources.Resource.txt`.
